    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden">
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          <p className="max-w-2xl mx-auto text-gray-400 text-lg md:text-xl mb-12 leading-relaxed">
            ප්‍රවීණ ගුරුවරුන්ගෙන්, සිංහල මාධ්‍යයෙන් උසස් තත්ත්වයේ පාඨමාලා සහ තාක්ෂණික දැනුම ලබාගන්න.
          </p>
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            {
              title: "ලිපි සහ බ්ලොග්",
              desc: "තාක්ෂණය සහ වෘත්තීය දියුණුව පිළිබඳ ලිපි රාශියක්.",
              icon: FileText,
            ...
            {
              title: "පෙළ පාඨමාලා",
              desc: "ඕනෑම වේලාවක කියවා අවබෝධ කරගත හැකි පාඨමාලා.",
              icon: BookOpen,
              color: "from-indigo-500 to-blue-600",
              href: "/text-courses",
            },
            {
              title: "වීඩියෝ පාඨමාලා",
              desc: "ඉහළ ගුණාත්මක වීඩියෝ මගින් ප්‍රායෝගිකව ඉගෙන ගන්න.",
              icon: Video,
      ...
      <section className="pb-32 px-6">
        <div className="max-w-7xl mx-auto py-12 glass rounded-[3rem] border-white/5 flex flex-wrap items-center justify-center gap-12 md:gap-24 text-gray-400 px-8">
          <div className="flex items-center gap-3">
            ...
            <span className="font-semibold text-white/80">ආරක්ෂිත ගෙවීම්</span>
          </div>
          <div className="flex items-center gap-3">
            <GraduationCap className="text-violet-400" />
            <span className="font-semibold text-white/80">සහතිකපත් පාඨමාලා</span>
          </div>
          <div className="flex items-center gap-3">
            <Sparkles className="text-blue-400" />
            <span className="font-semibold text-white/80">නිරන්තර යාවත්කාලීන</span>
          </div>
        </div>
      </section>

      <footer className="py-12 px-6 border-t border-white/5 text-center text-gray-500 text-sm glass mt-auto">
        <p>© 2026 Premium LMS (Sri Lanka). All Rights Reserved.</p>
        <div className="mt-4 flex justify-center gap-6">
          <Link href="#" className="hover:text-white transition-colors">නියමයන් සහ කොන්දේසි</Link>
          <Link href="#" className="hover:text-white transition-colors">පෞද්ගලිකත්ව ප්‍රතිපත්තිය</Link>
        </div>
      </footer>
    </div>
  );
